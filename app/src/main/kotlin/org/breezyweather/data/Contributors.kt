...
val appTranslators = arrayOf(
    ...
    TranslatorItem(arrayOf("bn"), "Abhishek Dasgupta", github = "abdasgupta"),
    ...
    TranslatorItem(arrayOf("da"), "hao123111230", github = "hao123111230"),
    ...
    TranslatorItem(arrayOf("de"), "ich Bin May", weblate = "Maxterdf"),
    TranslatorItem(arrayOf("de"), "Nonni", github = "nonni-heere"),
    ...
    TranslatorItem(arrayOf("el"), "Makis", github = "80-svg"),
    ...
    TranslatorItem(arrayOf("eo"), "tuxayo", github = "tuxayo"),
    ...
    TranslatorItem(arrayOf("es"), "Richa371", github = "Richa371"),
    TranslatorItem(arrayOf("es"), "No name", weblate = "CertainBot"),
    ...
    TranslatorItem(arrayOf("fa"), "hulse", weblate = "hulse"),
    ...
    TranslatorItem(arrayOf("fi"), "Jiri Grönroos", weblate = "artnay"),
    ...
    TranslatorItem(arrayOf("gl"), "ninjum", github = "ninjum"),
    ...
    TranslatorItem(arrayOf("id"), "Arif Budiman", github = "arifpedia"),
    ...
    TranslatorItem(arrayOf("it"), "Nicola Cesarini", weblate = "Cianfrugo"),
    ...
    TranslatorItem(arrayOf("ko"), "Coding-Young", github = "Coding-Young"),
    ...
    TranslatorItem(arrayOf("nl"), "Stephan Paternotte", github = "Stephan-P"),
    ...
    TranslatorItem(arrayOf("pt"), "Manuela Silva", github = "mansil"),
    ...
    TranslatorItem(arrayOf("pt_rBR"), "Lucas", github = "lucasmz-dev"),
    ...
    TranslatorItem(arrayOf("ro"), "Nicolae Fericitu", github = "NicolaeFericitu"),
    ...
    TranslatorItem(arrayOf("ru"), "Yurt Page", github = "yurtpage"),
    ...
    TranslatorItem(arrayOf("sk", "cs"), "Milan", weblate = "Milan"),
    ...
    TranslatorItem(arrayOf("sv"), "EfraimTheDoggo", github = "EfraimTheDoggo"),
    TranslatorItem(arrayOf("sv"), "Mona Lisa", weblate = "MonaLisa"),
    ...
    TranslatorItem(arrayOf("ta"), "hhharsha36", github = "hhharsha36"),
    TranslatorItem(arrayOf("th"), "Wari", github = "wwwwwwari"),
    TranslatorItem(arrayOf("th"), "ACHN SYPS", github = "achn-syps"),
    TranslatorItem(arrayOf("th", "ja"), "ikkue", github = "ikkue"),
    ...
    TranslatorItem(arrayOf("uk"), "Максим Горпиніч", weblate = "Maksim2005UKR"),
    ...
    TranslatorItem(arrayOf("vi"), "pham the minh", github = "wikiepeidia"),
